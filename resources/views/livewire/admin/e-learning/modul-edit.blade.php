<div class="space-y-5">
    ...
    <div class="flex items-center gap-3">
        ...
        <h2 class="text-base font-bold text-gray-800 tracking-tight">Edit Modul E-Learning</h2>
    </div>
        ...
        <div class="lg:col-span-2 space-y-4">
                ...
                <div class="p-5 space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="link_video" type="url"
            ...
            shadow-[0_1px_0_rgba(255,255,255,.9)_inset]">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-xs font-semibold text-green-700 truncate">{{ basename($modul->file_path) }}</p>
                            <p class="text-[10px] text-green-500 mt-0.5">File aktif saat ini</p>
                        </div>
                        <div class="flex items-center gap-2 flex-shrink-0">
                            <a href="{{ asset('storage/'.$modul->file_path) }}" target="_blank"
                                class="text-xs font-semibold text-green-600 hover:text-green-800
                                        bg-green-100 hover:bg-green-200 px-2.5 py-1 rounded-lg
                                        transition-all duration-200">
                                                        Lihat
                            </a>
                            <button type="button"
                                @click="$store.deleteModal.show(
                                    'Hapus File Materi',
                                    'Yakin ingin menghapus file &quot;{{ addslashes(basename($modul->file_path)) }}&quot;? File tidak bisa dikembalikan.',
                                    () => $wire.hapusFile()
                                )"
                   ...
                   px-2.5 py-1 rounded-lg transition-all duration-200">
                    ...
                    <div>
                        <label class="block text-[10.5px] font-bold text-stone-500 uppercase tracking-widest mb-1.5">
                            {{ $modul->file_path ? 'Ganti File Materi' : 'Upload File Materi' }}
                        </label>
                        <div
                            x-data="{
            isDragging: false,
            ...
            clearFile() {
                ...
                : 'border-stone-200 hover:border-orange-300 hover:bg-orange-50/30'"
                                ...
                                @click="document.getElementById('fileInputEdit').click()">
                                ...
                                <p x-show="!isDragging" class="text-sm font-semibold text-stone-500 mb-1">Drag & drop file di sini</p>
                                <p x-show="isDragging" class="text-sm font-bold text-orange-500 mb-1">Lepaskan untuk upload!</p>
                                ...
                                <div class="flex items-center gap-3">
                                  ...
                                  'text-stone-500': !['pdf','doc','docx','ppt','pptx'].includes(fileType)
                                        ...
                                        <div class="flex items-center gap-1 mt-1.5">
                                            ...
                                            <span class="text-[10px] text-green-600 font-medium">Siap diupload — akan menggantikan file lama</span>
                                        </div>
                                    </div>
            ...
            <div class="bg-white rounded-2xl border border-stone-100 overflow-hidden
                ...
                <div class="p-5 space-y-4">
                    <div>
                        ...
                        <input wire:model="min_quiz_score" type="number" min="0" max="100"
                            class="w-full px-3.5 py-2.5 text-sm border border-stone-200 rounded-xl bg-stone-50 text-stone-800
                    ...
                    <div class="border border-stone-100 rounded-2xl p-4 space-y-3
                        ...
                        <textarea wire:model="soal.{{ $i }}.pertanyaan" rows="2"
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-2xl border border-stone-100 p-5
                ...
                <button wire:click="simpan" wire:loading.attr="disabled"
                    ...
                    <span wire:loading.remove wire:target="simpan" class="relative">Update Modul</span>
            ...
            <div class="bg-white rounded-2xl border border-stone-100 p-5
                ...
                <div class="flex items-center gap-2 mb-3">
                    <div class="w-7 h-7 rounded-xl flex items-center justify-center bg-blue-50 border border-blue-100">
                    ...
                    <p class="text-xs font-bold text-stone-700">Tips Edit Modul</p>
                </div>
                <ul class="space-y-2">
                    @foreach([
                    'Perubahan akan langsung aktif setelah disimpan',
                    'Upload file baru akan menggantikan file lama',
                    'Peserta yang sudah selesai tidak terpengaruh perubahan kuis',
                    'Nonaktifkan publish agar peserta tidak melihat saat diedit'
                    ] as $tip)
