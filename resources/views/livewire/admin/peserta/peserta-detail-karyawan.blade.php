    ...
    <div class="relative overflow-hidden rounded-2xl px-6 py-5 mb-5 text-white
        ...
        <div class="relative flex items-start justify-between gap-4">
            ...
            <div class="flex flex-col items-end gap-2 flex-shrink-0">
                ...
                <button
                    @click="$store.deleteModal.show('Setujui Karyawan', 'Setujui pendaftaran {{ $namaKaryawan }}? Karyawan dapat login ke sistem.', () => $wire.approve(), 'approve')"
               ...
               transition-all duration-200">
                ...
                <button
                    @click="$store.deleteModal.show('Tolak Karyawan', 'Tolak pendaftaran {{ $namaKaryawan }}? Karyawan tidak dapat login ke sistem.', () => $wire.reject(), 'reject')"
                    class="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold
