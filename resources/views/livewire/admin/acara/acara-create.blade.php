<div>
    ...
    <div class="mb-5 p-4 bg-green-50 border border-green-200 rounded-2xl flex items-center gap-3">
        ...
        <p class="text-sm text-green-700 font-medium flex-1">Acara berhasil ditambahkan!</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="bg-white rounded-2xl border border-stone-200 overflow-hidden
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <input wire:model="nama" type="text" placeholder="Contoh: Pelatihan BLS 2026"
                                class="w-full px-3.5 py-2.5 text-sm border border-stone-200 rounded-xl bg-stone-50 text-stone-800 outline-none
                                       focus:border-orange-400 focus:ring-2 focus:ring-orange-400/15 focus:bg-white
                        ...
                        <div>
                            ...
                            <input wire:model="namaNarasumber" type="text" placeholder="Nama narasumber (pisah koma jika lebih dari satu)"
                                class="w-full px-3.5 py-2.5 text-sm border border-stone-200 rounded-xl bg-stone-50 text-stone-800 outline-none
                                       focus:border-orange-400 focus:ring-2 focus:ring-orange-400/15 focus:bg-white
                                       transition-all duration-200" />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input wire:model="durasi" type="number" min="1" placeholder="Jam"
                                    class="w-full px-3.5 py-2.5 text-sm border border-stone-200 rounded-xl bg-stone-50 text-stone-800 outline-none
                                           focus:border-orange-400 focus:ring-2 focus:ring-orange-400/15 focus:bg-white
                                           transition-all duration-200" />
                            ...
                            <div>
                                ...
                                <input wire:model="kuota" type="number" min="1" placeholder="Jumlah peserta"
                                    class="w-full px-3.5 py-2.5 text-sm border border-stone-200 rounded-xl bg-stone-50 text-stone-800 outline-none
                                           focus:border-orange-400 focus:ring-2 focus:ring-orange-400/15 focus:bg-white
                                           transition-all duration-200" />
                ...
                <div class="bg-white rounded-2xl border border-stone-200 overflow-hidden
                    ...
                    <div class="p-5"
                        x-data="{
                             ...
                             handleFile(e) {
                                 ...
                                 $wire.upload('img', file,
                                     () => { this.uploading = false; this.saved = true; },
                        ...
                        <div class="aspect-video rounded-xl border-2 border-dashed border-stone-200 bg-stone-50
                                    overflow-hidden flex items-center justify-center mb-3
                            ...
                            <template x-if="preview">
                                <div class="relative w-full h-full">
                                    ...
                                    <div x-show="saved" class="absolute inset-0 bg-green-500/20 flex items-center justify-center">
                                        <span class="bg-green-500 text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-md">✓ Siap disimpan</span>
                                    </div>
                                </div>
                            </template>
                            <template x-if="!preview">
                        ...
                        <p x-show="uploading" class="text-xs text-pink-500 animate-pulse text-center mb-2">Mengupload gambar...</p>
                        ...
                        <label class="relative flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl cursor-pointer
                                      text-white text-[12.5px] font-semibold overflow-hidden
                            ...
                            <span class="relative">Pilih Gambar</span>
                            <input type="file" accept="image/jpeg,image/png,image/webp" @change="handleFile($event)" class="sr-only" />
                        </label>

                        <p class="text-xs text-stone-400 text-center mt-1.5"
                            x-text="fileName || 'JPG, PNG — maks 2MB. Rasio 16:9 disarankan.'"></p>
            ...
            transition-shadow duration-300">
                        ...
                        <div class="flex items-center justify-between p-3 bg-stone-50 border border-stone-200 rounded-xl">
                            ...
                            <button type="button"
                                ...
                                <span class="absolute top-1 w-4 h-4 rounded-full bg-white shadow-[0_1px_4px_rgba(0,0,0,.22)] transition-all duration-200"
                                    style="{{ $publish ? 'left:23px' : 'left:4px' }}">
                                </span>
                            </button>
                        </div>
                ...
                <div class="bg-white rounded-2xl border border-stone-200 overflow-hidden
                    ...
                    <div class="p-5 space-y-2.5">
                        ...
                        <button type="submit"
                            ...
                            <span wire:loading.remove wire:target="save" class="relative">Simpan Acara</span>
                            <span wire:loading wire:target="save" class="relative">Menyimpan...</span>
                        </button>

                        {{-- Reset --}}
                        <button type="button" wire:click="$refresh"
                            class="w-full flex items-center justify-center gap-2 py-2.5 rounded-2xl border border-stone-200 cursor-pointer
                                   text-stone-500 text-sm font-semibold
                                   bg-gradient-to-br from-stone-50 to-stone-100
                                   shadow-[0_1px_0_rgba(255,255,255,.95)_inset,0_2px_8px_rgba(120,113,108,.09)]
                                   hover:from-stone-100 hover:to-stone-200 hover:-translate-y-px
                                   hover:shadow-[0_1px_0_rgba(255,255,255,.9)_inset,0_5px_14px_rgba(120,113,108,.14)]
                                   active:scale-[.97] transition-all duration-200">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-sky-50 border border-blue-200 rounded-2xl p-4
                    ...
                    <p class="flex items-center gap-1.5 text-xs font-bold text-blue-700 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke-width="2.2" stroke="currentColor">
                    ...
                    <ul class="space-y-1.5">
                        <li class="flex items-start gap-2 text-[11.5px] text-blue-600">
                            ...
                            QR Code dibuat otomatis saat acara disimpan
                        </li>
                        <li class="flex items-start gap-2 text-[11.5px] text-blue-600">
                            <span class="w-1.5 h-1.5 rounded-full bg-blue-300 mt-1 flex-shrink-0"></span>
                            QR default nonaktif, aktifkan saat acara mulai
                        </li>
                        <li class="flex items-start gap-2 text-[11.5px] text-blue-600">
                            <span class="w-1.5 h-1.5 rounded-full bg-blue-300 mt-1 flex-shrink-0"></span>
                            Upload materi &amp; sertifikat di halaman detail
                        </li>
                    </ul>
                </div>
